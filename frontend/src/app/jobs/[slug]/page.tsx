...
export default async function JobDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const educationDisplayValue = job.educationSpecialization?.trim() || job.minEducation.join(", ");
            ...
            <div className="bg-white border border-zinc-100 rounded-2xl p-6 shadow-sm space-y-6" data-testid="job-detail">
              ...
              {job.minEducation.length > 0 && (
                <section>
                  ...
                  <p className="text-base font-medium text-zinc-800">{educationDisplayValue}</p>
                </section>
              )}
